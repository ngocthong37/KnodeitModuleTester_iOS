...
- (void)receivedMessageFrom:(NSString*) from link:(NSString*)link date:(NSDate*) date
{
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"EverAfter" withExtension:@"momd"];
